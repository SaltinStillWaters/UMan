...
public class PasswordField extends JPasswordField {
    ...
    public PasswordField() {
        setBorder(new EmptyBorder(30, 3, 5, 30));
        ...
        addMouseMotionListener(new MouseMotionAdapter() {
            ...
            public void mouseMoved(MouseEvent me) {
                if (showAndHide) {
                    int x = getWidth() - 30;
                    if (new Rectangle(x, 0, 30, 90).contains(me.getPoint())) {
        ...
        eye = new ImageIcon(PasswordField.class.getClassLoader().getResource("eye.png")).getImage();
        eye_hide = new ImageIcon(PasswordField.class.getClassLoader().getResource("eye_hide.png")).getImage();
